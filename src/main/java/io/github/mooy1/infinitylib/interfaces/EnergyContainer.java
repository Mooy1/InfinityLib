...
public interface EnergyContainer extends TickingContainer, EnergyNetComponent {
    ...
    boolean process(@Nonnull BlockMenu menu, @Nonnull Block b, @Nonnull Config data);

    @Override
    default void tick(@Nonnull BlockMenu menu, @Nonnull Block b, @Nonnull Config data) {
