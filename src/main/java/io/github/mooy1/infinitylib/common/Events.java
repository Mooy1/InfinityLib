...
public final class Events implements Listener {
    ...
    /**
     * Registers the given handler to the given event with monitor priority and ignoring cancelled events
     */
    public static <T extends Event> void addHandler(Class<T> eventClass, Consumer<T> handler) {
        addHandler(eventClass, EventPriority.MONITOR, handler);
    }

    /**
     * Registers the given handler to the given event ignoring cancelled events
     */
    public static <T extends Event> void addHandler(Class<T> eventClass, EventPriority priority, Consumer<T> handler) {
        addHandler(eventClass, priority, true, handler);
    }
